<template>
  <footer class="footer center">
    ...
    <div class="footer__menu">
      <p class="footer__menu-title">страницы</p>
      <a class="footer__menu-link" href="#">Домой</a>
      <a class="footer__menu-link" href="#">Проект</a>
      <a class="footer__menu-link" href="#">Блог</a>
    </div>
